...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 142, s: 84, l: 39 }; // Defaults to green-ish
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '142 84 39', // HSL default matching primary (green)
  ...
  coneSpread = 25,
  animated = false,
  colors = ['#00FF41', '#00CC33', '#114422'], // Green HSL neon colors
  fillOpacity = 0.5,
}) => {
